...
public class ManagerService {
	...
	public static void reviewReimbursements() {
		System.out.println("Reimbursements to be reviewed");
		
	}

	public static void viewAllPendingReimbursements() {
		System.out.println("Pending Reimbursements");
		
	}

	public static void viewResolvedReimbursements() {
	...
	public static void viewEmployeeRequests() {
